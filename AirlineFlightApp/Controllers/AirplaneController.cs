...
namespace AirlineFlightApp.Controllers
{
    public class AirplaneController : Controller
    {
        ...
        static AirplaneController()
        {
            ...
            client.BaseAddress = new Uri("https://localhost:44379/api/AirplaneData/");
        }
